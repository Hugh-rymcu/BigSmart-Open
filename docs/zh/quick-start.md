...
本指南面向 **RYMCU BigSmart 开发板**，内容根据 `E:\RYMCU\xiaozhi` 工程中的 `main/boards/rymcu-bigsmart` 板级代码整理。它用于帮助用户快速完成开机、联网、语音交互、SD 卡资源准备、视频播放、音乐播放、USB 磁盘模式和 NES 游戏模式。
